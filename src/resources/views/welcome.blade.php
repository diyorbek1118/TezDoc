...
<body>
    ...
    <!-- Navbar -->
    <div class="absolute top-0 left-0 w-full flex justify-between items-center px-20 py-6 bg-white/80 backdrop-blur-sm shadow z-50">
        <a href="/" class="text-3xl font-bold text-indigo-600">TalabaLocation</a>
        ...
        <div class="flex items-center space-x-6 mr-20">
            ...
            <a href="{{ route('register') }}" 
               class="px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-500 shadow font-medium">
                Register
            </a>
        </div>
    </div>
  ...
  <!-- component -->
<div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 top-20">
    ...
    <div class="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
                ...
                <div class="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <div class="mt-10 flex flex-col items-center md:flex-row">
                        <a href="/" class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            View More</a>
                        <a href="https://www.samtuit.uz/uz" aria-label="" class="group inline-flex items-center font-semibold text-xs text-blue-600" target="_blank">SamTuit haqida
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div class="mx-auto w-[600px] h-[500px] overflow-hidden rounded-[3rem] rounded-br-none rounded-tl-none">
    <img src="{{ Vite::asset('resources/images/tatu10.png') }}" 
         alt="about"
