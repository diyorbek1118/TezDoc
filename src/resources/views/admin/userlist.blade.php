...
<!-- component -->
<div class="max-w-full table-fixed ml-[35rem]">

    <div class="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border pt-5">
                       ...
                       class="relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-red-600 transition-all hover:bg-red-600/10 active:bg-red-600/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        ...
                        <span class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                                class="w-5 h-5">
                                <path fill-rule="evenodd" d="M9 3.75A2.25 2.25 0 0111.25 1.5h1.5A2.25 2.25 0 0115 3.75V4.5h4.5a.75.75 0 010 1.5h-.71l-1.17 14.02a2.25 2.25 0 01-2.24 2.23H8.62a2.25 2.25 0 01-2.24-2.23L5.21 6H4.5a.75.75 0 010-1.5H9v-.75zm1.5.75v-.75a.75.75 0 01.75-.75h1.5a.75.75 0 01.75.75v.75h-3zM7.72 6l1.08 13.01a.75.75 0 00.75.74h6.9a.75.75 0 00.75-.74L16.28 6H7.72z" clip-rule="evenodd" />
                            </svg>
                        </span>
                    </button>
                </td>
