...
@parent
      ...
      <main class="flex flex-col md:flex-row shadow-lg rounded-3xl justify-center items-start max-w-6xl mx-auto my-5 gap-4 w-full px-2">
        
        <section class="w-full md:w-1/2 bg-gray-100 p-4 rounded-xl bg-gray-50 h-full overflow-y-scroll">
        ...
        <section class="w-full md:w-1/2 bg-gray-100 p-4 rounded-xl bg-white ">
